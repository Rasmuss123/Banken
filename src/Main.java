...
public class Main {
    public static void main(String args[]){
        ...
        int balance=0,tmp=0;
        int withd=0,cb=0;
// Generera ett account nummer
        int aNumber = 0;

// name,acc_number,Balance,Type, även göra en scanner så man kan skriva i menyn
        ...
        do {
            ...
            switch (userChoice) {
                ...
                case 1:
                    ...
                    type=in.next();
                    user.insert(user_name, aNumber, type);  // insert= sätta in allt
                    System.out.println("\n\tYour Account Details\n\tDont Forget Account Number\n");
                    System.out.println("**************************");
                    user.display_details();
                    break;

                case 2: // deposite/Lägga in pengar
                ...
                case 3: // withdraw money/ta ut pengar
                    System.out.print("Enter your account Number : ");
                    tmp=in.nextInt();
                ...
                case 5: // visa all information om ditt account
